                        ...
                        >
                            ...
                            >
                                <Grid
                                    ...
                                    lg={12}
                                    // sx={{p:5}}
                                    sx={{display: 'flex', flexDirection: 'column', justifyContent:'end', alignItems:'center'}}
                                >
                                    <img
                                        src={Avatar}
                                        alt='avatar'
                                ...
                                <Grid
                                    ...
                                    lg={12}
                                    // sx={{p:5}}
                                    sx={{display: 'flex', flexDirection: 'column', justifyContent:'end', alignItems:'center', height: '100%'}}
                                >
                                    <Grid
                                        item
                                        xs={12}
                                    ...
                                    </Grid>
                                    {
                                        error 
                                            ...
                                            <Grid
                                                ...
                                                lg={12}
                                                sx={{px:10, py:2, pb:3}} 
                                                style={{backgroundColor:'rgba(255,50,50,0.2)', borderRadius:'20px'}}
                                            >
