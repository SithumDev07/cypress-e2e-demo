...
describe('Create class', () => {
    ...
    describe("Authorized users", () => {
        ...
        describe("Select paymentLink", () => {
            beforeEach(() => {
                cy.get('[data-cy=payment-link]').find('input').as('PaymentLinkTextField');
            });
            ...
            it("should payment link text field placeholder exists", () => {
                cy.get("@PaymentLinkTextField").invoke("attr", "placeholder").should("eq", "Enter payment link generated by payhere")
            });

            it("should focus and blur the payment link text field", () => {
                cy.get("@PaymentLinkTextField").type("something").should('have.focus').blur().should("not.have.focus");
            });
        ...
        describe("Select classFee", () => {
         ...
         describe("Select admissionFee", () => {
            beforeEach(() => {
                cy.get('[data-cy=admission-fee]').find("input").as("AdmissionFeeTextField");
            });
            ...
            it("should admission fee text field placeholder exists", () => {
                cy.get("@AdmissionFeeTextField").invoke("attr", "placeholder").should("eq", "Enter admission fee amount");
            });

            it("should focus and blur the admission fee text field", () => {
                cy.get("@AdmissionFeeTextField").type("something").should("have.focus").blur().should("not.have.focus");
            });
